...
Rails.application.configure do
  ...
  # Configure mailer to use SMTP (supports both ENV vars and Rails credentials)
  ...
  config.action_mailer.default_url_options = { host: "dev.onepunch.work", protocol: "https" }
  Rails.application.routes.default_url_options = { host: "dev.onepunch.work", protocol: "https" }
  ...
  config.hosts << "dev.onepunch.work"
